...
class RedBlackTreeIterator {
   ...
   */
  reversed() {
    return new RedBlackTreeIterator(this.self, this.stack.slice(), this.direction === exports.Direction.Forward ? exports.Direction.Backward : exports.Direction.Forward);
  }
  /**
   * Iterator next
   */
  next() {
    ...
    this.count++;
    if (this.direction === exports.Direction.Forward) {
      this.moveNext();
    } else {
      this.movePrev();
    }
