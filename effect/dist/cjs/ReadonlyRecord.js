...
exports.singleton = exports.getEquivalence = exports.difference = exports.intersection = exports.union = exports.some = exports.every = exports.reduce = exports.isSubrecord = exports.isSubrecordBy = exports.update = exports.upsert = exports.values = exports.keys = exports.partition = exports.separate = exports.partitionMap = exports.compact = exports.filter = exports.filterMap = exports.map = exports.pop = exports.remove = exports.replaceOption = exports.modifyOption = exports.get = exports.has = exports.size = exports.toEntries = exports.collect = exports.fromEntries = exports.fromIterable = exports.isEmptyReadonlyRecord = exports.isEmptyRecord = exports.empty = void 0;
 ...
 * @since 2.0.0
 */
exports.isEmptyReadonlyRecord = exports.isEmptyRecord;
/**
 ...
 * @since 2.0.0
 */
exports.fromIterable = /*#__PURE__*/(0, Function_js_1.dual)(2, (self, f) => {
  const out = {};
  for (const a of self) {
    const [k, b] = f(a);
    out[k] = b;
 ...
 * @since 2.0.0
 */
exports.fromEntries = /*#__PURE__*/(0, exports.fromIterable)(Function_js_1.identity);
/**
 ...
 * @since 2.0.0
 */
exports.collect = /*#__PURE__*/(0, Function_js_1.dual)(2, (self, f) => {
  const out = [];
 ...
 * @since 2.0.0
 */
exports.toEntries = /*#__PURE__*/(0, exports.collect)((key, value) => [key, value]);
/**
 ...
 * @since 2.0.0
 */
exports.has = /*#__PURE__*/(0, Function_js_1.dual)(2, (self, key) => Object.prototype.hasOwnProperty.call(self, key));
/**
 ...
 * @since 2.0.0
 */
exports.get = /*#__PURE__*/(0, Function_js_1.dual)(2, (self, key) => (0, exports.has)(self, key) ? Option.some(self[key]) : Option.none());
/**
 ...
 * @since 2.0.0
 */
exports.modifyOption = /*#__PURE__*/(0, Function_js_1.dual)(3, (self, key, f) => {
 ...
 * @since 2.0.0
 */
exports.replaceOption = /*#__PURE__*/(0, Function_js_1.dual)(3, (self, key, b) => (0, exports.modifyOption)(self, key, () => b));
/**
 ...
 * @since 2.0.0
 */
exports.remove = /*#__PURE__*/(0, Function_js_1.dual)(2, (self, key) => {
  const out = {
    ...self
  };
  delete out[key];
 ...
 * @since 2.0.0
 */
exports.pop = /*#__PURE__*/(0, Function_js_1.dual)(2, (self, key) => (0, exports.has)(self, key) ? Option.some([self[key], (0, exports.remove)(self, key)]) : Option.none());
/**
 ...
 * @since 2.0.0
 */
const values = self => (0, exports.collect)(self, (_, a) => a);
 ...
 * @since 2.0.0
 */
exports.upsert = /*#__PURE__*/(0, Function_js_1.dual)(3, (self, key, value) => {
  const out = {
    ...self
  };
  out[key] = value;
 ...
 * @since 2.0.0
 */
exports.update = /*#__PURE__*/(0, Function_js_1.dual)(3, (self, key, value) => {
  const out = {
    ...self
  };
  if ((0, exports.has)(self, key)) {
 ...
 * @since 2.0.0
 */
const isSubrecordBy = equivalence => (0, Function_js_1.dual)(2, (self, that) => {
  for (const key in self) {
    if (!(0, exports.has)(that, key) || !equivalence(self[key], that[key])) {
      return false;
    }
  }
  return true;
 ...
 * @since 2.0.0
 */
exports.isSubrecord = /*#__PURE__*/(0, exports.isSubrecordBy)( /*#__PURE__*/Equal.equivalence());
/**
 ...
 * @since 2.0.0
 */
exports.every = /*#__PURE__*/(0, Function_js_1.dual)(2, (self, predicate) => {
  for (const key in self) {
    if (!predicate(self[key], key)) {
      return false;
    }
 ...
 * @since 2.0.0
 */
exports.union = /*#__PURE__*/(0, Function_js_1.dual)(3, (self, that, combine) => {
  if ((0, exports.isEmptyRecord)(self)) {
    return {
      ...that
    };
  }
  if ((0, exports.isEmptyRecord)(that)) {
    return {
      ...self
    };
  }
 ...
 * @since 2.0.0
 */
exports.intersection = /*#__PURE__*/(0, Function_js_1.dual)(3, (self, that, combine) => {
  if ((0, exports.isEmptyRecord)(self) || (0, exports.isEmptyRecord)(that)) {
 ...
 * @since 2.0.0
 */
exports.difference = /*#__PURE__*/(0, Function_js_1.dual)(2, (self, that) => {
  if ((0, exports.isEmptyRecord)(self)) {
    return {
      ...that
    };
...
const getEquivalence = equivalence => {
  const is = (0, exports.isSubrecordBy)(equivalence);
